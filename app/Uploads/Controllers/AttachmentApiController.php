    ...
    protected function rules(Request $request): array
    {
        return [
            'create' => [
                ...
                'file'        => array_merge(['required_without:link'], $this->attachmentService->getFileValidationRules($request->file('file'))),
                'link'        => ['required_without:file', 'string', 'min:1', 'max:2000', 'safe_url'],
            ],
            'update' => [
                'name'        => ['string', 'min:1', 'max:255'],
                'uploaded_to' => ['integer', 'exists:pages,id'],
                'file'        => $this->attachmentService->getFileValidationRules($request->file('file')),
