...
class SearchController extends Controller
{
    ...
    public function search(Request $request, SearchResultsFormatter $formatter)
    {
        ...
        //save search history
        $this->searchRunner->saveSearchHistory($fullSearchString);
    ...
    /**
     * Search the history of searches made by the current user.
     */
    public function searchHistory()
    {
        // $searches = $this->searchRunner->getSearchHistory(user());

        // return view('search.parts.entity-history-list', ['entities' => $searches]);
        $entities = $this->searchRunner->getSearchHistory(user())['results'];
